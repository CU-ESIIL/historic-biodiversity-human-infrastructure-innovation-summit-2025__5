...
**What this code does:** Calculates where infrastructure corridors intersect areas of high biodiversity value.
**Inputs needed:** `data/biodiversity_occurrences.geojson`, `data/infrastructure_corridors.geojson`
**How to run it:**
```bash
python code/corridor_overlap.py
```
**What to look for:** Weighted overlap metrics, summary table, and annotated map layers.
**Results:** [outputs/corridor_overlap.png](outputs/corridor_overlap.png)
````
